                ...
                <div className="container-fluid">
                    <div className="row mb-2">
                        ...
                        <ol className="breadcrumb float-sm-right">
                            ...
                            <li className="breadcrumb-item active">Módulos PESV</li>
                    ...
                    <div className="card">
                        <div className="card-header">
                            <h3 className="card-title">Módulos Plan Estratégico de Seguridad Vial</h3>
                        </div>
                        {/* /.card-header */}
                            ...
                            <div id="accordion">
                                <div className="card card-light">
                                    ...
                                    <div id="collapseOne" className="collapse" data-parent="#accordion">
                                        <div className="card-body">
                                            Si desea cargar otra acta para el líder de diseño e implementación PESV haga clic en el botón.
                                        </div>
                                        <div className="card-footer">
                                            <a href="/actalideres2" className="btn btn-primary btn-sm">Reasignar Líder</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="card card-light">
                                    ...
                                    <div id="collapseTwo" className="collapse" data-parent="#accordion">
                                        <div className="card-body">
                                            Si desea cargar otra acta para el comité de seguridad vial haga clic en el botón.
                                        </div>
                                        <div className="card-footer">
                                            <a href="/actalideres" className="btn btn-primary btn-sm">Reasignar Comité</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="card card-light">
                                    ...
                                    <div id="collapseThree" className="collapse" data-parent="#accordion">
                                        <div className="card-body">
                                            Si desea cargar otra acta para la política de seguridad vial haga clic en el botón.
                                        </div>
                                        <div className="card-footer">
                                            <a href="/actalideres" className="btn btn-primary btn-sm">Reasignar Política</a>
                                        </div>
                                    </div>
                                </div>
                                <div className="card card-light">
                                    <div className="card-header">
                                        <h4 className="card-title w-100">
                                            ...
                                            Paso #4 - Liderazgo, compromiso y correspondencia del nivel directivo
                                            </a>
                                        </h4>
                                    </div>

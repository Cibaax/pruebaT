                                                    ...
                                                    <div className="card-body table-responsive p-0" style={{ height: 400 }}>
                                                        <table className="table table-head-fixed">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        a. La definición de la política y los objetivos del PESV. que sean compatibles con la dirección
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        b. Promover en la organización la formación y aplicación de hábitos, comportamientos y
                                                                        conductas seguras en la vía.
                                                                    </td>
                                                                    <td>
                                                                        <select className="form-control" {...register("b", { required: true })}>
                                                                            <option selected={true}>NO</option>
                                                                            <option>SI</option>
                                                                        </select>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        c. El suministro de recursos financieros, técnicos y humanos requeridos para el diseño,
                                                                        implementación, verificación y mejora del PESV.
                                                                    </td>
                                                                    <td>
                                                                        <select className="form-control" {...register("c", { required: true })}>
                                                                            <option selected={true}>NO</option>
                                                                            <option>SI</option>
                                                                        </select>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <select className="form-control" {...register("d", { required: true })}>
                                                                            <option selected={true}>NO</option>
                                                                            <option>SI</option>
                                                                        </select>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        e. El seguimiento para que los contratistas, afiliados, asociados, terceros y la comunidad de la
                                                                        organización cumplan los requisitos de seguridad vial que establezca la organización.
                                                                    </td>
                                                                    <td>
                                                                        <select className="form-control" {...register("e", { required: true })}>
                                                                            <option selected={true}>NO</option>
                                                                            <option>SI</option>
                                                                        </select>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        f. El cumplimiento de las acciones y estrategias definidas en el plan de trabajo anual del PESV.
                                                                    </td>
                                                                    <td>
                                                                        <select className="form-control" {...register("f", { required: true })}>
                                                                            <option selected={true}>NO</option>
                                                                            <option>SI</option>
                                                                        </select>
                                                                    </td>
                                                                    <td>
                                                                        Política y objetivos gerenciales relacionados con la SV.</td>
                                                                    <td>HSEQ, Gerencia</td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                        g. La atención oportuna de la solicitud de información por parte de las entidades verificadoras, la
                                                                    ...
                                                                    <td>
                                                                        <select className="form-control" {...register("g", { required: true })}>
                                                                            <option selected={true}>NO</option>
                                                                            <option>SI</option>
                                                                        </select>
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        h. La participación en una (1) reunión del comité de seguridad vial por lo menos una (1) vez al
